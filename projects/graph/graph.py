...
if __name__ == '__main__':
    ...
    print('graph.dft: ')
    graph.dft("c")
    print('graph.dft_recursive: ')
    graph.dft_recursive(1)
    # '''
    # Valid BFS path:
    #     [1, 2, 4, 6]
    # '''
    print('graph.bfs: start -> destination ')
    print(graph.bfs(1, "a"))
    # '''
    # Valid DFS paths:
    #     [1, 2, 4, 6]
    #     [1, 2, 4, 7, 6]
    # '''
    print('graph.dfs: start -> destination ')
    print(graph.dfs(1, "b"))
    print('graph.dfs_recursive: start -> destination ')
